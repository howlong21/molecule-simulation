...
add_z1 = [["h2o", 18, 1, 10]]
add_z2 = [["h2o", 18, 1, 10]]
add_y = [["na", 18, 1, 300]]  # name mol/g density number
...
char_dic = {"st": 2.1000, "ao": 1.5750, "ob": -1.0500, "obts": -1.1688, "obos": -1.1808,
            ...
            "hoy": 0.4250, "eow": -0.8476, "ehw": 0.4238, "na": 1.0000,
            "ow": -0.8476, "hw": 0.4238, "emgo": 1.2292, "cl": -1.0000}   # charge dictionary
...
pair_coeff = {"st": [0.0000018405, 3.30203000], "at": [0.0000018405, 3.30203000],
              ...
              "cl": [0.1001000000, 4.3999620]}   # pair_coeff dictionary
bond_coeff = {"ho-oh": [554.1300, 1.000], "eow-ehw": [554.1300, 1.000], "hw-ow": [450.2698, 1.000]}
ang_coeff = {"ho-oh-Al": [15.00000, 110.10000], "ho-oh-Si": [6.00000, 110.10000],
             "ehw-eow-ehw": [33.43000, 109.47000], "hw-ow-hw": [33.43000, 109.47000]}
dih_coeff = {}
imp_coeff = {}
mol_bond = []
mol_ang = []
...
def readmon2():
    ...
    tmp_z = zz_sort[len(zz_sort)-1] - zz_sort[0] + 1.5
    file1 = open(xyzpath)
    file1.readline()
    box[2] += tmp_z + 10
    content = file1.readlines()
